 ...
 * Description：InterTabController
 * Author： Chance_写代码的厨子
 * Create Time：2021-08-11 17:34:01
 */
namespace CookPopularControl.Controls.Dragables
{
    public class InterTabController : FrameworkElement
    {
        ...
        public static readonly DependencyProperty HorizontalPopoutGraceProperty =
            DependencyProperty.Register("HorizontalPopoutGrace", typeof(double), typeof(InterTabController), new PropertyMetadata(8.0));
        ...
        public static readonly DependencyProperty VerticalPopoutGraceProperty =
            DependencyProperty.Register("VerticalPopoutGrace", typeof(double), typeof(InterTabController), new PropertyMetadata(8.0));
        ...
        public static readonly DependencyProperty MoveWindowWithSolitaryTabsProperty =
            DependencyProperty.Register("MoveWindowWithSolitaryTabs", typeof(bool), typeof(InterTabController), new PropertyMetadata(true));
        ...
        public static readonly DependencyProperty InterTabClientProperty =
            DependencyProperty.Register("InterTabClient", typeof(IInterTabClient), typeof(InterTabController), new PropertyMetadata(new DefaultInterTabClient()));
