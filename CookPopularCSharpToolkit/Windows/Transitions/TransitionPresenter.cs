...
namespace CookPopularCSharpToolkit.Windows.Transitions
{
    ...
    public class TransitionPresenter : FrameworkElement
    {
        ...
        private static object CoerceClipToBounds(object element, object value)
        {
            ...
            {
                TransitionBase transition = transitionElement.Transition;
        ...
        public static readonly DependencyProperty TransitionProperty =
            DependencyProperty.Register("Transition", typeof(TransitionBase), typeof(TransitionPresenter), new UIPropertyMetadata(null, null, CoerceTransition));
        ...
        private void BeginTransition()
        {
            ...
            TransitionBase transition = selector != null ?
        ...
        private TransitionBase _activeTransition;
    }
}
