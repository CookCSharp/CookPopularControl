...
namespace CookPopularCSharpToolkit.Communal
{
    ...
    public class UIThreadCollection<T> : ReadOnlyObservableCollection<T>
    {
        ...
        private UIThreadCollection(ReadOnlyCollection<T> sourceItems, ObservableCollectionPlus<T> activeItems, int minCount, int maxCount, int initialCount) : base(activeItems)
        {
            ...
            m_addCommand = new AnotherCommandImplementation(o => Add(), o => CanAddOrInsert);
            m_insertCommand = new AnotherCommandImplementation(o => Insert(), o => CanAddOrInsert);
            m_removeCommand = new AnotherCommandImplementation(o => Remove(), o => CanRemove);
            m_moveCommand = new AnotherCommandImplementation(o => Move(), o => CanMove);
            m_changeCommand = new AnotherCommandImplementation(o => Change(), o => CanChange);
            m_resetCommand = new AnotherCommandImplementation(o => Reset());
        ...
        private readonly AnotherCommandImplementation m_addCommand, m_removeCommand, m_moveCommand, m_changeCommand, m_insertCommand, m_resetCommand;
