...
namespace CookPopularCSharpToolkit.Communal
{
    public class MultiComparer<TObject> : IComparer<TObject>
    {
        ...
        private static FuncComparer<TObject> BuildAscendingComparer<TAttribute>(Func<TObject, TAttribute> accessor) where TAttribute : IComparable
        {
        ...
        private static FuncComparer<TObject> BuildDescendingComparer<TAttribute>(Func<TObject, TAttribute> accessor) where TAttribute : IComparable
        {
            //TODO handle ref types better
